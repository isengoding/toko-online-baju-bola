                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                <img class="d-block w-100" alt="asd" height="400"
                                    src="{{ asset('assets/img/product/' . $carouselProducts->first()->image) }}">
                            </div>
                            @foreach ($carouselProducts->skip(1) as $item)
                                <div class="carousel-item">
                                    <img class="d-block w-100" alt="Product Image" height="400"
                                        src="{{ asset('assets/img/product/' . $item->image) }}">
                                </div>
                            @endforeach
