                ...
                <div class="col-12">
                    <div class="card">
                                        ...
                                        <tr>
                                            ...
                                            <td data-label="Image">
                                                <div class="d-flex py-1 align-items-top">
                                                    <a data-fslightbox="gallery"
                                                        href="{{ asset('assets/img/brand/' . $row->image) }}">
                                                        <span class="avatar me-2"
                                                            style="background-image: url({{ asset('assets/img/brand/' . $row->image) }})"></span>
                                            ...
                                            <td class="align-text-top">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end" style="">
                                                    <a class="dropdown-item" href="{{ route('brands.edit', $row->id) }}">
                                                        <i class="ti ti-edit icon text-secondary me-2"></i>
                                                        Edit
                                                    </a>
                                                    <a class="dropdown-item text-danger" href="#"
                                                        onclick="handleDelete(`{{ route('brands.destroy', $row->id) }}`)">
                        ...
                        <div class="card-footer d-flex justify-content-center align-items-center">
                            {{ $brands->onEachSide(1)->withQueryString()->withPath(request()->fullUrl())->links() }}
                        </div>
                    </div>
                </div>
