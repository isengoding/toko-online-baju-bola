                ...
                <div class="col-12">
                    <div class="card">
                                ...
                                <tbody>
                                    @forelse ($users as $row)
                                        <tr>
                                            ...
                                            <td class="align-text-top" data-label="Name">
                                                {{ $row->name }}
                                            </td>
                                            <td class="align-text-top" data-label="Email">
                                                {{ $row->email }}
                                            </td>
                                            <td class="align-text-top" data-label="Role">
                                                {{ $row->role }}
                                            </td>
                                            ...
                                            <td class="align-text-top">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end" style="">
                                                    ...
                                                    <a class="dropdown-item text-danger" href="#"
                                                        onclick="handleDelete(`{{ route('users.destroy', $row->id) }}`)">
                        ...
                        <div class="card-footer d-flex justify-content-center align-items-center">
                            {{ $users->onEachSide(1)->withQueryString()->withPath(request()->fullUrl())->links() }}
                        </div>
                    </div>
                </div>
