                                            ...
                                            <td data-label="Product">
                                                <div class="d-flex py-1 align-items-top">
                                                    <a data-fslightbox="gallery"
                                                        href="{{ asset('assets/img/product/' . $row->image) }}">
                                                        <span class="avatar me-2"
                                                            style="background-image: url({{ asset('assets/img/product/' . $row->image) }})"></span>

                                                    </a>
                                                    <div class="flex-fill">
                                                        <div class="font-weight-medium">{{ $row->name }}</div>
                                                        <div class="text-secondary"><a href="#"
                                                                class="text-reset">{{ $row->sku }}</a></div>
                                                    </div>
                                                </div>
                                            </td>

                                            <td class="align-text-top text-start text-lg-center" data-label="Brand">
                                                <img src="{{ asset('assets/img/brand/' . $row->brand->image) }}"
                                                    alt="{{ $row->brand->image }}" height="40" width="40"
                                                    class="py-1" title="{{ $row->brand->name }}">
                                                {{-- {{ $row->brand->name }} --}}
                                            </td>

                                            <td class="align-text-top text-start text-lg-center" data-label="Team">
                                                <img src="{{ asset('assets/img/team/' . $row->team->image) }}"
                                                    alt="{{ $row->team->image }}" height="40" width="40"
                                                    class="py-1" title="{{ $row->team->name }}">
                                                {{-- {{ $row->team->name }} --}}
                                            </td>
                                            <td class="align-text-top text-start text-lg-center" data-label="Type">
                                                {{ $row->type }}
                                            </td>
