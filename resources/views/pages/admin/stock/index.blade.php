            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <a href="{{ route('stocks.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <div class="col-12">
                    <div class="card">
                                    ...
                                    @forelse ($stocks as $row)
                                        <tr>
                                            <td class="text-secondary align-text-top" data-label="No">
                                                {{ $loop->iteration + $stocks->firstItem() - 1 }}
                                            </td>
                                            <td data-label="Product">
                                                <div class="d-flex py-1 align-items-top">
                                                    <a data-fslightbox="gallery"
                                                        href="{{ asset('assets/img/product/' . $row->product->image) }}">
                                                        <span class="avatar me-2"
                                                            style="background-image: url({{ asset('assets/img/product/' . $row->product->image) }})"></span>

                                                    </a>
                                                    <div class="flex-fill">
                                                        <div class="font-weight-medium">{{ $row->product->name }} -
                                                            {{ \Str::ucfirst($row->product->type) }}</div>
                                                        <div class="text-secondary"><a href="#"
                                                                class="text-reset">{{ $row->product->sku }}</a>
                                            ...
                                            <td class="align-text-top text-start text-lg-center" data-label="Size">
                                            ...
                                            <td class="align-text-top">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end" style="">
                                                    <a class="dropdown-item" href="{{ route('stocks.edit', $row->id) }}">
                                                        <i class="ti ti-edit icon text-secondary me-2"></i>
                                                        Edit
                                                    </a>
                                                    <a class="dropdown-item text-danger" href="#"
                                                        onclick="handleDelete(`{{ route('stocks.destroy', $row->id) }}`)">
                        ...
                        <div class="card-footer d-flex justify-content-center align-items-center">
                            {{ $stocks->onEachSide(1)->withQueryString()->withPath(request()->fullUrl())->links() }}
                        </div>
                    </div>
                </div>
