                ...
                <div class="col-12">
                    <div class="card">
                                    ...
                                    @forelse ($teams as $row)
                                        <tr>
                                            <td class="text-secondary align-text-top" data-label="No">
                                                {{ $loop->iteration + $teams->firstItem() - 1 }}
                                            </td>
                                            <td data-label="Image">
                                                <div class="d-flex py-1 align-items-top">
                                                    <a data-fslightbox="gallery"
                                                        href="{{ asset('assets/img/team/' . $row->image) }}">
                                                        <span class="avatar me-2"
                                                            style="background-image: url({{ asset('assets/img/team/' . $row->image) }})"></span>
                                            ...
                                            <td class="align-text-top" data-label="Team Name">
                                                {{ $row->name }}
                                            </td>
                                            ...
                                            <td class="align-text-top">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end" style="">
                                                    ...
                                                    <a class="dropdown-item text-danger" href="#"
                                                        onclick="handleDelete(`{{ route('teams.destroy', $row->id) }}`)">
                        ...
                        <div class="card-footer d-flex justify-content-center align-items-center">
                            {{ $teams->onEachSide(1)->withQueryString()->withPath(request()->fullUrl())->links() }}
                        </div>
                    </div>
                </div>
